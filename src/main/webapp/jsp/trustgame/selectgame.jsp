...
/* submit register form with selected game user id */
function submitSelectedGameUser() {
  document.getElementById("recordNr").setAttribute("value", document.getElementById("gameUser").value);
...
<body>
  <div class="tg-login-page">
    ...
    <div class="tg-login-body">
      ...
      <div class="tg-login">
        <p>Multiple games found for this login name or login code.<br>Make a selection:</p>
        ${trustGameData.getSelectUserHtml()}
      </div>
